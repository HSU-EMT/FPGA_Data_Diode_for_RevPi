...
proc create_root_design { parentCell } {
  ...
  # Create instance: Shared_Memory_PLC, and set properties
  set Shared_Memory_PLC [ create_bd_cell -type ip -vlnv xilinx.com:ip:blk_mem_gen:8.4 Shared_Memory_PLC ]
  set_property -dict [ list \
   CONFIG.Byte_Size {8} \
   CONFIG.EN_SAFETY_CKT {true} \
   CONFIG.Enable_32bit_Address {true} \
  ...
  # Create instance: axi_bram_ctrl_PLC_Ethernet_2, and set properties
  set axi_bram_ctrl_PLC_Ethernet_2 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_bram_ctrl:4.1 axi_bram_ctrl_PLC_Ethernet_2 ]
  set_property -dict [ list \
   CONFIG.SINGLE_PORT_BRAM {1} \
 ] $axi_bram_ctrl_PLC_Ethernet_2
  ...
  # Create instance: axi_bram_ctrl_PLC_RS485_2, and set properties
  set axi_bram_ctrl_PLC_RS485_2 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_bram_ctrl:4.1 axi_bram_ctrl_PLC_RS485_2 ]
  set_property -dict [ list \
   CONFIG.SINGLE_PORT_BRAM {1} \
 ] $axi_bram_ctrl_PLC_RS485_2
  ...
  connect_bd_intf_net -intf_net PLC_Uart_Tx_enable_GPIO [get_bd_intf_ports PLC_RS485_Uart_Tx_enable] [get_bd_intf_pins AXI_GPIO_PLC_RS485_Uart_Tx/GPIO]
  ...
  connect_bd_intf_net -intf_net axi_bram_ctrl_PLC_Ethernet_2_BRAM_PORTA [get_bd_intf_pins Shared_Memory_PLC/BRAM_PORTA] [get_bd_intf_pins axi_bram_ctrl_PLC_Ethernet_2/BRAM_PORTA]
  connect_bd_intf_net -intf_net axi_bram_ctrl_PLC_RS485_2_BRAM_PORTA [get_bd_intf_pins Shared_Memory_PLC/BRAM_PORTB] [get_bd_intf_pins axi_bram_ctrl_PLC_RS485_2/BRAM_PORTA]
  ...
  connect_bd_intf_net -intf_net microblaze_PLC_Ethernet_axi_periph_M03_AXI [get_bd_intf_pins axi_bram_ctrl_PLC_Ethernet_2/S_AXI] [get_bd_intf_pins microblaze_PLC_Ethernet_axi_periph/M03_AXI]
  ...
  connect_bd_intf_net -intf_net microblaze_PLC_RS485_axi_periph_M07_AXI [get_bd_intf_pins axi_bram_ctrl_PLC_RS485_2/S_AXI] [get_bd_intf_pins microblaze_PLC_RS485_axi_periph/M07_AXI]
  ...
  connect_bd_intf_net -intf_net microblaze_PLC_axi_periph_M03_AXI [get_bd_intf_pins AXI_GPIO_PLC_RS485_Uart_Tx/S_AXI] [get_bd_intf_pins microblaze_PLC_RS485_axi_periph/M03_AXI]
  connect_bd_intf_net -intf_net microblaze_PLC_axi_periph_M04_AXI [get_bd_intf_pins AXI_GPIO_PLC_RS485_Uart_Rx/S_AXI] [get_bd_intf_pins microblaze_PLC_RS485_axi_periph/M04_AXI]
  connect_bd_intf_net -intf_net microblaze_PLC_axi_periph_M05_AXI [get_bd_intf_pins AXI_GPIO_PLC_RS485_Wire1/S_AXI] [get_bd_intf_pins microblaze_PLC_RS485_axi_periph/M05_AXI]
  connect_bd_intf_net -intf_net microblaze_PLC_axi_periph_M06_AXI [get_bd_intf_pins AXI_GPIO_PLC_RS485_Wire2/S_AXI] [get_bd_intf_pins microblaze_PLC_RS485_axi_periph/M06_AXI]
  ...
  connect_bd_net -net clk_wiz_clk_out28 [get_bd_pins axi_quad_spi_PLCM/ext_spi_clk] [get_bd_pins axi_quad_spi_PLC_Ethernet/ext_spi_clk] [get_bd_pins clk_wiz/clk_out28]
  ...
  connect_bd_net -net microblaze_0_Clk [get_bd_pins AXI_GPIO_PLCM_Uart_Rx/s_axi_aclk] [get_bd_pins AXI_GPIO_PLCM_Uart_Tx/s_axi_aclk] [get_bd_pins AXI_GPIO_PLCM_Wire1/s_axi_aclk] [get_bd_pins AXI_GPIO_PLCM_Wire2/s_axi_aclk] [get_bd_pins AXI_GPIO_PLC_RS485_Uart_Rx/s_axi_aclk] [get_bd_pins AXI_GPIO_PLC_RS485_Uart_Tx/s_axi_aclk] [get_bd_pins AXI_GPIO_PLC_RS485_Wire1/s_axi_aclk] [get_bd_pins AXI_GPIO_PLC_RS485_Wire2/s_axi_aclk] [get_bd_pins axi_bram_ctrl_1_PLCM/s_axi_aclk] [get_bd_pins axi_bram_ctrl_2_PLCM/s_axi_aclk] [get_bd_pins axi_bram_ctrl_PLC_Ethernet/s_axi_aclk] [get_bd_pins axi_bram_ctrl_PLC_Ethernet_2/s_axi_aclk] [get_bd_pins axi_bram_ctrl_PLC_RS485/s_axi_aclk] [get_bd_pins axi_bram_ctrl_PLC_RS485_2/s_axi_aclk] [get_bd_pins axi_quad_spi_PLCM/s_axi_aclk] [get_bd_pins axi_quad_spi_PLC_Ethernet/s_axi_aclk] [get_bd_pins axi_uartlite_PLCM/s_axi_aclk] [get_bd_pins axi_uartlite_PLC_RS485/s_axi_aclk] [get_bd_pins clk_wiz/clk_out100] [get_bd_pins microblaze_PLCM/Clk] [get_bd_pins microblaze_PLCM_axi_intc/processor_clk] [get_bd_pins microblaze_PLCM_axi_intc/s_axi_aclk] [get_bd_pins microblaze_PLCM_axi_periph/ACLK] [get_bd_pins microblaze_PLCM_axi_periph/M00_ACLK] [get_bd_pins microblaze_PLCM_axi_periph/M01_ACLK] [get_bd_pins microblaze_PLCM_axi_periph/M02_ACLK] [get_bd_pins microblaze_PLCM_axi_periph/M03_ACLK] [get_bd_pins microblaze_PLCM_axi_periph/M04_ACLK] [get_bd_pins microblaze_PLCM_axi_periph/M05_ACLK] [get_bd_pins microblaze_PLCM_axi_periph/M06_ACLK] [get_bd_pins microblaze_PLCM_axi_periph/M07_ACLK] [get_bd_pins microblaze_PLCM_axi_periph/M08_ACLK] [get_bd_pins microblaze_PLCM_axi_periph/S00_ACLK] [get_bd_pins microblaze_PLCM_local_memory/LMB_Clk] [get_bd_pins microblaze_PLC_Ethernet/Clk] [get_bd_pins microblaze_PLC_Ethernet_axi_intc/processor_clk] [get_bd_pins microblaze_PLC_Ethernet_axi_intc/s_axi_aclk] [get_bd_pins microblaze_PLC_Ethernet_axi_periph/ACLK] [get_bd_pins microblaze_PLC_Ethernet_axi_periph/M00_ACLK] [get_bd_pins microblaze_PLC_Ethernet_axi_periph/M01_ACLK] [get_bd_pins microblaze_PLC_Ethernet_axi_periph/M02_ACLK] [get_bd_pins microblaze_PLC_Ethernet_axi_periph/M03_ACLK] [get_bd_pins microblaze_PLC_Ethernet_axi_periph/S00_ACLK] [get_bd_pins microblaze_PLC_Ethernet_local_memory/LMB_Clk] [get_bd_pins microblaze_PLC_RS485/Clk] [get_bd_pins microblaze_PLC_RS485_axi_intc/processor_clk] [get_bd_pins microblaze_PLC_RS485_axi_intc/s_axi_aclk] [get_bd_pins microblaze_PLC_RS485_axi_periph/ACLK] [get_bd_pins microblaze_PLC_RS485_axi_periph/M00_ACLK] [get_bd_pins microblaze_PLC_RS485_axi_periph/M01_ACLK] [get_bd_pins microblaze_PLC_RS485_axi_periph/M02_ACLK] [get_bd_pins microblaze_PLC_RS485_axi_periph/M03_ACLK] [get_bd_pins microblaze_PLC_RS485_axi_periph/M04_ACLK] [get_bd_pins microblaze_PLC_RS485_axi_periph/M05_ACLK] [get_bd_pins microblaze_PLC_RS485_axi_periph/M06_ACLK] [get_bd_pins microblaze_PLC_RS485_axi_periph/M07_ACLK] [get_bd_pins microblaze_PLC_RS485_axi_periph/S00_ACLK] [get_bd_pins microblaze_PLC_RS485_local_memory/LMB_Clk] [get_bd_pins rst_clk_wiz_100M/slowest_sync_clk]
  connect_bd_net -net reset_rtl_1 [get_bd_ports reset] [get_bd_pins clk_wiz/resetn] [get_bd_pins rst_clk_wiz_100M/ext_reset_in]
  connect_bd_net -net rst_clk_wiz_150M_bus_struct_reset [get_bd_pins microblaze_PLCM_local_memory/SYS_Rst] [get_bd_pins microblaze_PLC_Ethernet_local_memory/SYS_Rst] [get_bd_pins microblaze_PLC_RS485_local_memory/SYS_Rst] [get_bd_pins rst_clk_wiz_100M/bus_struct_reset]
  connect_bd_net -net rst_clk_wiz_150M_interconnect_aresetn [get_bd_pins microblaze_PLCM_axi_periph/ARESETN] [get_bd_pins microblaze_PLC_RS485_axi_periph/ARESETN] [get_bd_pins rst_clk_wiz_100M/interconnect_aresetn]
  connect_bd_net -net rst_clk_wiz_150M_mb_reset [get_bd_pins microblaze_PLCM/Reset] [get_bd_pins microblaze_PLCM_axi_intc/processor_rst] [get_bd_pins microblaze_PLC_Ethernet/Reset] [get_bd_pins microblaze_PLC_Ethernet_axi_intc/processor_rst] [get_bd_pins microblaze_PLC_RS485/Reset] [get_bd_pins microblaze_PLC_RS485_axi_intc/processor_rst] [get_bd_pins rst_clk_wiz_100M/mb_reset]
  ...
  create_bd_addr_seg -range 0x00002000 -offset 0xC1000000 [get_bd_addr_spaces microblaze_PLC_Ethernet/Data] [get_bd_addr_segs axi_bram_ctrl_PLC_Ethernet_2/S_AXI/Mem0] SEG_axi_bram_ctrl_PLC_Ethernet_2_Mem0
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x40010000 [get_bd_addr_spaces microblaze_PLC_RS485/Data] [get_bd_addr_segs AXI_GPIO_PLC_RS485_Uart_Tx/S_AXI/Reg] SEG_AXI_PLC_Uart_Tx_Reg
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x40030000 [get_bd_addr_spaces microblaze_PLC_RS485/Data] [get_bd_addr_segs AXI_GPIO_PLC_RS485_Wire2/S_AXI/Reg] SEG_AXI_PLC_Wire2_Reg
  ...
  create_bd_addr_seg -range 0x00002000 -offset 0xC1000000 [get_bd_addr_spaces microblaze_PLC_RS485/Data] [get_bd_addr_segs axi_bram_ctrl_PLC_RS485_2/S_AXI/Mem0] SEG_axi_bram_ctrl_PLC_RS485_2_Mem0
